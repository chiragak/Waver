...
<div class="login-form">    
    <form action="forgotpassword.php" method="post">
	    ...
	    <input type="submit" onclick="myFunction()" class="btn btn-primary  btn-s" value="Submit">  
                </div>
	...
	<div id="a" style="display:none">
	 <form action="forgotpassword.php" method="post">
        ...
        <div class="form-group">
            <input type="NUMBER" class="form-control" placeholder="OTP" name ='submit-otp' required="required">
        </div>
        <div class="form-group">
